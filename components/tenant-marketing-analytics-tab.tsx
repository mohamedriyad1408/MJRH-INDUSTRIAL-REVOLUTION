...
"توصيل وخدمات": { count: 0, gmv: 0 },
 ...
 <span> ساعة الركود المقترحة لعروض التسويق: <strong className="text-teal-400 font-mono">14:00 - 16:00 عصراً</strong></span>
 </div>
 </CardContent>
 </Card>
 </div>
 ...
 <span className="text-amber-300 font-bold"> تنبيه: لم يتم تسجيل مصروفات حملات إعلانية بعد. اضغط على زر"إضافة حملة ومصروف تسويقي"بالأعلى لحساب ROAS وقاعدة الأربعين حياً.</span>
)}
 </div>
 </div>
