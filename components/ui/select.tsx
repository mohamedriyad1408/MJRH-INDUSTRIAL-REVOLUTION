...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      // Mobile h-11 (44px) for touch-friendly dropdowns; md:h-9 restores the
      // compact desktop density so existing layouts stay visually identical.
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="h-4 w-4 opacity-50 rtl:-scale-x-100" />
