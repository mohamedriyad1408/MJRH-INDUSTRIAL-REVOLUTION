...
import { useAuth, type AppRole } from "@/core/auth/useAuth";
 ...
 const groups = (() => {
   if (!isSuperAdmin && coreNavItems.length > 0) {
     const labels: Record<string, string> = {
       ...
       laundry_operations: "التشغيل والمحطات",
       owner_dashboard: "لوحة المالك",
       customer_service: "خدمة العملاء",
       intake: "الاستلام",
       reception: "الاستقبال",
       sorting: "الفرز والتصنيف",
       cleaning: "التنظيف والمعالجة",
       finishing: "التشطيب والكي",
       quality_control: "مراقبة الجودة",
       packing: "التغليف",
       delivery: "التوصيل",
       finance_control: "الرقابة المالية",
       management: "الإدارة",
       accounting: "الحسابات",
       sales: "المبيعات",
       marketing: "التسويق",
       ...
       field_service: "التوصيل والعمل الميداني",
       workflow: "التشغيل وسير العمل",
