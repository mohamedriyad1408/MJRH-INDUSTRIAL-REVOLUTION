      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          <Card className="rounded-3xl shadow-sm border">
            <CardHeader className="bg-slate-50/80 pb-3"><CardTitle className="text-base font-black flex items-center gap-2"><Shirt className="w-5 h-5 text-violet-600" /> 🏷️ قطع الملابس الواردة للفرز الفني ولصق المارك (Barcode Tagging)</CardTitle></CardHeader>
            <CardContent className="p-4 space-y-3">
