...
function ReceptionPage() {
 ...
 {loading ? (<div className="flex justify-center p-8"><Loader2 className="w-5 h-5 animate-spin text-teal-600" /></div>) : (<div className="space-y-6" dir={dir}>
 ...
 {walkIn.length === 0 ? (<Card className="rounded-3xl border-dashed"><CardContent className="p-8 text-center text-sm text-slate-400 font-bold">لا توجد فواتير داخلية معلقة حالياً في الاستقبال</CardContent></Card>) : (<div className="space-y-3">
 {walkIn.map((o) => (<OrderCard
 ...
 {assignFor && (<AssignEmployeeDialog
 open={!!assignFor}
...
function OrderCard({
 ...
 {canMove && (<div className="flex gap-1 shrink-0">
