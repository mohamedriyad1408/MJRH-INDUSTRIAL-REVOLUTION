...
function typeAr(s: string, t: any) { return ({ cash: t("account.type.cash", "خزنة"), bank: t("account.type.bank", "بنك"), wallet: t("account.type.wallet", "محفظة"), instapay: "InstaPay" } as any)[s] ?? s; }
function catAr(s: string, t: any) { return ({ salaries: t("expense.cat.salaries", "رواتب"), rent: t("expense.cat.rent", "إيجار"), water: t("expense.cat.water", "مياه"), electricity: t("expense.cat.electricity", "كهرباء"), supplies: t("expense.cat.supplies", "خامات"), maintenance: t("expense.cat.maintenance", "صيانة"), other: t("expense.cat.other", "أخرى") } as any)[s] ?? s; }
function entryAr(s: string, t: any) { return ({ salary_accrual: t("ledger.entry.salary_accrual", "استحقاق راتب"), commission_accrual: t("ledger.entry.commission_accrual", "استحقاق عمولة"), advance: t("ledger.entry.advance", "سلفة"), advance_deduction: t("ledger.entry.advance_deduction", "خصم سلفة"), salary_payment: t("ledger.entry.salary_payment", "صرف راتب"), adjustment: t("ledger.entry.adjustment", "تسوية") } as any)[s] ?? s; }
