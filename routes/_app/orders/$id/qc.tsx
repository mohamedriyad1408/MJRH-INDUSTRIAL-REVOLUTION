    ...
    <div className="p-6 max-w-lg mx-auto">
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-muted-foreground font-mono text-xs">معرف الطلب: {id}</p>

          <div className="space-y-2">
            <label className="text-sm font-bold">ملاحظات الفحص</label>
            <Textarea
              className="w-full"
              placeholder="ملاحظات اختيارية عن حالة الملابس بعد التشغيل..."
              value={notes}
