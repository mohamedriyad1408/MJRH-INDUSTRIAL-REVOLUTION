      ...
      {loading ? <div className="flex justify-center p-12"><Loader2 className="w-6 h-6 animate-spin text-teal-600" /></div> : data && (
        <div className="space-y-6" dir={dir}>
          <div className="grid grid-cols-2 lg:grid-cols-6 gap-3">
            ...
            <Kpi label={t("stations.common.orders")} value={data.totalOrders} tone="blue" sub={`${data.delivered} ${t("reports.del")}`} />
            ...
            <Kpi label={t("stations.qc.title")} value={`${data.qcRate.toFixed(1)}%`} tone={data.qcRate > 8 ? "red" : "green"} sub={t("reports.failureRate")} />
          </div>
