...
function OpsDashboard() {
  ...
  const cards = [
    { label: t("today.kpi.ordersToday"), value: stats.today, icon: Calendar, to: "/orders" as const },
        ...
        <Card>
          <CardContent className="p-4 space-y-2">
            <div className="flex justify-between items-center">
              ...
              <Link to="/staff" className="text-xs text-primary underline">{t("ops.manage")}</Link>
            </div>
            {activeTeam.map((e) => (
        ...
        <Card>
          <CardContent className="p-4 space-y-2">
            <div className="flex justify-between items-center">
              ...
              <Link to="/staff/requests" className="text-xs text-primary underline">{t("ops.viewAll")}</Link>
            </div>
      ...
      <Card>
        <CardContent className="p-4 space-y-2">
          ...
          <div className="flex flex-wrap gap-2 pt-2">
            <Link to="/stations/reception" className="text-xs px-3 py-1 rounded border hover:bg-muted">{t("stage.received")}</Link>
            <Link to="/stations/cleaning" className="text-xs px-3 py-1 rounded border hover:bg-muted">{t("stage.cleaning")}</Link>
            <Link to="/stations/ironing" className="text-xs px-3 py-1 rounded border hover:bg-muted">{t("stage.ironing")}</Link>
            <Link to="/stations/packing" className="text-xs px-3 py-1 rounded border hover:bg-muted">{t("stage.packing")}</Link>
            <Link to="/stations/delivery" className="text-xs px-3 py-1 rounded border hover:bg-muted">{t("stage.ready")}</Link>
          </div>
        </CardContent>
      </Card>
    </div>
