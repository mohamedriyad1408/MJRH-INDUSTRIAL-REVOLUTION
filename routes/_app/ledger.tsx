...
function LedgerPage() {
  ...
  return <div className="space-y-5">
    <div className="flex flex-wrap items-center justify-between gap-3">
      <div><h1 className="text-2xl font-black flex items-center gap-2"><BookOpenCheck className="w-7 h-7 text-teal-600" />القيود والتقارير المالية</h1><p className="text-sm text-muted-foreground">قيود مزدوجة، أرباح وخسائر، ميزان مراجعة، وإقفال شهري.</p></div>
