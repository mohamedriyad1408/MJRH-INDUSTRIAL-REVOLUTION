...
function SuperAdminTelemetryPage() {
 ...
 return (<div className="space-y-8 max-w-7xl mx-auto pb-24" dir={dir}>
 {/* Header */}
 ...
 </div>) : filteredIncidents.length === 0 ? (<Card className="p-16 text-center border-dashed rounded-3xl text-slate-400 font-bold space-y-3 bg-white">
 ...
 {inc.isResolved && (<Badge className="bg-emerald-600 text-white font-bold text-xs">
 ...
 {inc.stackOrDetail && (<div className="p-3 rounded-2xl bg-slate-900 text-slate-200 font-mono text-xs overflow-x-auto border border-slate-700/80 mt-2">
 ...
 {inc.isResolved && inc.resolutionNotes && (<div className="p-3 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-900 text-xs font-bold mt-2">
 <span className="font-black">📝 تقرير المعالجة والتحديث البرمجي:</span> {inc.resolutionNotes}
 </div>)}
 </div>

 <div className="flex flex-col sm:items-end gap-2 shrink-0">
 {!inc.isResolved && (<Button
 ...
 {inc.actionUrl && (<Button asChild variant="outline" size="sm" className="font-bold rounded-2xl border-slate-300 hover:bg-slate-100">
