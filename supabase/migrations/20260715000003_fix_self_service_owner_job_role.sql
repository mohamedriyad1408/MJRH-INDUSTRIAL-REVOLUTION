-- Fix self-service organization creation after Platform Generator pivot.
-- job_role is an operational enum and does not include 'owner'; owner authority lives in app_role/user_roles.
...
COMMENT ON FUNCTION public.self_service_create_tenant IS 'Creates only account + organization shell. The mandatory setup wizard/generator initializes the platform. Owner employee uses generic job_role=other.';
