...
const publicTranslations: Record<LanguageCode, Record<string, string>> = {
  ar: {
    ...
    "landing.heroText": "MJRH ليس برنامج مغسلة فقط؛ هو منظومة تشغيل تشمل العمليات، المراحل المخصصة، فريق العمل، بوابة العميل، الخزن، القيود، التقارير، والتنبيهات الذكية. اختر قالب نشاطك وابدأ في دقائق.",
