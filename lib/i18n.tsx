...
const publicTranslations: Record<LanguageCode, Record<string, string>> = {
  ar: {
    ...
    "landing.heroTitle": "منصة واحدة تشغّل أي مشروع تشغيلي — من أول عملية لحد إقفال الخزنة.",
    "landing.heroText": "MJRH منظومة تشغيل متكاملة مصممة من الأساس لأي مشروع تشغيلي — مغسلة، ورشة، غسيل سيارات، تنظيف منازل، مطعم توصيل. تدير العمليات، المراحل المخصصة لكل نشاط، فريق العمل، بوابة العميل، الخزنة والمحاسبة، والتقارير والتنبيهات الذكية. اختر قالبك وابدأ في دقائق.",
